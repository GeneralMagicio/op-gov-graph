...
const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  return (
    <div className="fixed right-0 top-0 h-full w-80 bg-white shadow-lg p-4 overflow-y-auto transition-transform transform ease-in-out duration-300 translate-x-0">
      <button
        onClick={onClose}
